...
// NewOggIovecRef initialises a new struct holding the reference to the originaitng C struct.
func NewOggIovecRef(ref interface{}) *OggIovec {
	if ref == nil {
		return nil
	}
	...
	obj := new(OggIovec)
	obj.ref92a8e63c = (*C.ogg_iovec_t)(unsafe.Pointer(hdr.Ref))
	return obj
}
...
// NewOggPageRef initialises a new struct holding the reference to the originaitng C struct.
func NewOggPageRef(ref interface{}) *OggPage {
	if ref == nil {
		return nil
	}
	type ifaceHeader struct {
	...
	hdr := (*(*ifaceHeader)(unsafe.Pointer(&ref)))
	obj := new(OggPage)
	obj.refb80411d1 = (*C.ogg_page)(unsafe.Pointer(hdr.Ref))
	return obj
}
...
// NewOggStreamStateRef initialises a new struct holding the reference to the originaitng C struct.
func NewOggStreamStateRef(ref interface{}) *OggStreamState {
	if ref == nil {
		return nil
	}
	type ifaceHeader struct {
	...
	obj.refd2ebdd43 = (*C.ogg_stream_state)(unsafe.Pointer(hdr.Ref))
	return obj
}
...
// NewOggPacketRef initialises a new struct holding the reference to the originaitng C struct.
func NewOggPacketRef(ref interface{}) *OggPacket {
	if ref == nil {
		return nil
	}
	type ifaceHeader struct {
	...
	hdr := (*(*ifaceHeader)(unsafe.Pointer(&ref)))
	obj := new(OggPacket)
	obj.ref7954eecd = (*C.ogg_packet)(unsafe.Pointer(hdr.Ref))
	return obj
}
...
// NewOggSyncStateRef initialises a new struct holding the reference to the originaitng C struct.
func NewOggSyncStateRef(ref interface{}) *OggSyncState {
	if ref == nil {
		return nil
	}
	type ifaceHeader struct {
	...
	obj.ref69d6025b = (*C.ogg_sync_state)(unsafe.Pointer(hdr.Ref))
	return obj
}
...
// NewInfoRef initialises a new struct holding the reference to the originaitng C struct.
func NewInfoRef(ref interface{}) *Info {
	if ref == nil {
		return nil
	}
	type ifaceHeader struct {
	...
	hdr := (*(*ifaceHeader)(unsafe.Pointer(&ref)))
	obj := new(Info)
	obj.refd271fa3c = (*C.vorbis_info)(unsafe.Pointer(hdr.Ref))
	return obj
}
...
// unpackSSFloat transforms a sliced Go data structure into plain C format.
func unpackSSFloat(x [][]float32) (unpacked **C.float, allocs *cgoAllocMap) {
	if x == nil {
		return nil, nil
	}
	allocs = new(cgoAllocMap)
...
func packSSFloat(v [][]float32, ptr0 **C.float) {
	const m = 0x7fffffff
	for i0 := range v {
...
// NewDspStateRef initialises a new struct holding the reference to the originaitng C struct.
func NewDspStateRef(ref interface{}) *DspState {
	if ref == nil {
		return nil
	}
	type ifaceHeader struct {
	...
	hdr := (*(*ifaceHeader)(unsafe.Pointer(&ref)))
	obj := new(DspState)
	obj.refde21b9b1 = (*C.vorbis_dsp_state)(unsafe.Pointer(hdr.Ref))
	return obj
}
...
func (x *DspState) PassRef() (*C.vorbis_dsp_state, *cgoAllocMap) {
	...
	refde21b9b1.pcm, cpcm_allocs = unpackSSFloat(x.Pcm)
	allocsde21b9b1.Borrow(cpcm_allocs)

	var cpcmret_allocs *cgoAllocMap
	refde21b9b1.pcmret, cpcmret_allocs = unpackSSFloat(x.Pcmret)
...
func (x *DspState) Deref() {
	...
	packSSFloat(x.Pcm, x.refde21b9b1.pcm)
	packSSFloat(x.Pcmret, x.refde21b9b1.pcmret)
...
// NewBlockRef initialises a new struct holding the reference to the originaitng C struct.
func NewBlockRef(ref interface{}) *Block {
	if ref == nil {
		return nil
	}
	type ifaceHeader struct {
	...
	hdr := (*(*ifaceHeader)(unsafe.Pointer(&ref)))
	obj := new(Block)
	obj.ref5962d739 = (*C.vorbis_block)(unsafe.Pointer(hdr.Ref))
	return obj
}
...
func (x *Block) PassRef() (*C.vorbis_block, *cgoAllocMap) {
	...
	var cpcm_allocs *cgoAllocMap
	ref5962d739.pcm, cpcm_allocs = unpackSSFloat(x.Pcm)
...
func (x *Block) Deref() {
	...
	packSSFloat(x.Pcm, x.ref5962d739.pcm)
...
// NewCommentRef initialises a new struct holding the reference to the originaitng C struct.
func NewCommentRef(ref interface{}) *Comment {
	if ref == nil {
		return nil
	}
	type ifaceHeader struct {
	...
	hdr := (*(*ifaceHeader)(unsafe.Pointer(&ref)))
	obj := new(Comment)
	obj.ref4b9e021f = (*C.vorbis_comment)(unsafe.Pointer(hdr.Ref))
	return obj
}
...
// unpackArgSSSFloat transforms a sliced Go data structure into plain C format.
func unpackArgSSSFloat(x [][][]float32) (unpacked ***C.float, allocs *cgoAllocMap) {
	if x == nil {
		return nil, nil
	}
	allocs = new(cgoAllocMap)
...
// packSSSFloat reads sliced Go data structure out from plain C format.
func packSSSFloat(v [][][]float32, ptr0 ***C.float) {
	const m = 0x7fffffff
	for i0 := range v {
		ptr1 := (*(*[m / sizeOfPtr]**C.float)(unsafe.Pointer(ptr0)))[i0]
		for i1 := range v[i0] {
