...
func NewOggIovecRef(ref *C.ogg_iovec_t) *OggIovec {
	if ref == nil {
		return nil
	}
	obj := new(OggIovec)
...
func NewOggPageRef(ref *C.ogg_page) *OggPage {
	if ref == nil {
		return nil
	}
	obj := new(OggPage)
...
func NewOggStreamStateRef(ref *C.ogg_stream_state) *OggStreamState {
	if ref == nil {
		return nil
	}
...
func NewOggPacketRef(ref *C.ogg_packet) *OggPacket {
	if ref == nil {
		return nil
	}
	obj := new(OggPacket)
...
func NewOggSyncStateRef(ref *C.ogg_sync_state) *OggSyncState {
	if ref == nil {
		return nil
	}
...
func NewInfoRef(ref *C.vorbis_info) *Info {
	if ref == nil {
		return nil
	}
	obj := new(Info)
...
func packSInfo(v []Info, ptr0 *C.vorbis_info) {
	const m = 0x7fffffff
	for i0 := range v {
		ptr1 := (*(*[m]C.vorbis_info)(unsafe.Pointer(ptr0)))[i0]
		v[i0] = *NewInfoRef(&ptr1)
	}
}
...
func packSSFloat(v [][]float32, ptr0 **C.float) {
	const m = 0x7fffffff
	for i0 := range v {
		ptr1 := (*(*[m]*C.float)(unsafe.Pointer(ptr0)))[i0]
...
func NewDspStateRef(ref *C.vorbis_dsp_state) *DspState {
	if ref == nil {
		return nil
	}
	obj := new(DspState)
...
func packSDspState(v []DspState, ptr0 *C.vorbis_dsp_state) {
	const m = 0x7fffffff
	for i0 := range v {
		ptr1 := (*(*[m]C.vorbis_dsp_state)(unsafe.Pointer(ptr0)))[i0]
		v[i0] = *NewDspStateRef(&ptr1)
	}
}
...
func NewBlockRef(ref *C.vorbis_block) *Block {
	if ref == nil {
		return nil
	}
	obj := new(Block)
...
func NewCommentRef(ref *C.vorbis_comment) *Comment {
	if ref == nil {
		return nil
	}
	obj := new(Comment)
...
func packSOggPacket(v []OggPacket, ptr0 *C.ogg_packet) {
	const m = 0x7fffffff
	for i0 := range v {
		ptr1 := (*(*[m]C.ogg_packet)(unsafe.Pointer(ptr0)))[i0]
		v[i0] = *NewOggPacketRef(&ptr1)
	}
}
...
func packSSSFloat(v [][][]float32, ptr0 ***C.float) {
	...
	for i0 := range v {
		ptr1 := (*(*[m]**C.float)(unsafe.Pointer(ptr0)))[i0]
		for i1 := range v[i0] {
			ptr2 := (*(*[m]*C.float)(unsafe.Pointer(ptr1)))[i1]
